...
import {Get_Articles_Data} from '@/api/index'
let articles = ref([
  {
    id: 1,
    user_name: "一个",
    user_avatar:
      "http://127.0.0.1:8888/group1/M00/00/00/CgACD2GSbHaAam1fAAAoPzbaxt0990.jpg",
...
// 获取所有文章数据
const get_articles_data = async(data)=>{
  try {
    const res = await Get_Articles_Data(data)
